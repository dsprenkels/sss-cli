...
pub fn crypto_secretbox(w: &mut Write, r: &mut Read, nonce: &[u8], key: &[u8]) -> io::Result<()> {
...
pub fn crypto_secretbox_open(w: &mut Write,
                             r: &mut Read,
                             nonce: &[u8],
                             key: &[u8])
                             -> io::Result<Option<()>> {
